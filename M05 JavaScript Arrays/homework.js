...
function promedioResultadosTest(resultadosTest) {
   ...
   for (i = 0; i < resultadosTest.length; i++) {
      promedio = (resultado += resultadosTest[i]) / resultadosTest.length;
   }
   return promedio;
}
...
function mesesDelAño(array) {
   ...
   for(i = 0; i < array.length; i++) {
      if (array[i] === "Enero" || array[i] === "Marzo" || array[i] === "Noviembre") {
         monthsOrdered.push(array[i])
      }
   }
   return (monthsOrdered.length === 3) ? monthsOrdered: "No se encontraron los meses pedidos";
}
...
function mayorACien(array) {
   ...
   // Tu código:
   valuesGreaterThan100 = [];

   for(i = 0; i < array.length; i++) {
      if (array[i] > 100) {
         valuesGreaterThan100.push(array[i])
      }
   }
   return valuesGreaterThan100;
}
